...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PitchPilot AI — Build. Challenge. Pitch." },
      {
        name: "description",
        content:
          "Turn a rough startup idea into an investor-ready pitch deck, challenge it with an AI VC Critic, fix the weak points, and present.",
      },
      { name: "author", content: "PitchPilot AI" },
